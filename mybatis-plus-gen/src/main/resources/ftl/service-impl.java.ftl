package com.yicj.study.${module}.service.impl;
...
import com.yicj.study.${module}.repository.mapper.${entity}Mapper;
import com.yicj.study.${module}.service.I${entity}Service;
